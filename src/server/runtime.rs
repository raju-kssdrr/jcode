...
impl ServerRuntime {
    pub(super) fn from_server(server: &super::Server) -> Self {
        Self {
            ...
            swarm_members: Arc::clone(&server.swarm_members),
            swarms_by_id: Arc::clone(&server.swarms_by_id),
            shared_context: Arc::clone(&server.shared_context),
            swarm_plans: Arc::clone(&server.swarm_plans),
            swarm_coordinators: Arc::clone(&server.swarm_coordinators),
