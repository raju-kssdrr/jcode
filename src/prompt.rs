...
```json
{"name": "selfdev", "input": {"action": "build", "reason": "explain what changed"}} // Queue a coordinated background build
{"name": "selfdev", "input": {"action": "cancel-build", "request_id": "..."}} // Cancel your queued/running selfdev build request
...
8. **After reload, immediately continue your work** — do not stop and wait for user input
