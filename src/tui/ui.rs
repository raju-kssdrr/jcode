...
use theme_support::{
    ...
    animated_tool_color, asap_color, blend_color, color_to_floats, dim_color, file_link_color,
    header_animation_color, header_chrome_color, header_fade_color, header_fade_t,
