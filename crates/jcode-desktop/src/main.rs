...
const ASSISTANT_HEADING_TEXT_COLOR: [f32; 4] = [0.105, 0.255, 0.520, 0.95];
const ASSISTANT_QUOTE_TEXT_COLOR: [f32; 4] = [0.405, 0.250, 0.610, 0.90];
const ASSISTANT_TABLE_TEXT_COLOR: [f32; 4] = [0.090, 0.335, 0.385, 0.90];
const ASSISTANT_LINK_TEXT_COLOR: [f32; 4] = [0.045, 0.285, 0.650, 0.94];
